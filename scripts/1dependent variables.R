...
write.csv(plaspsv100df,"out/plaspsv100.csv")#Save PSV of Plasmodium assemblages
plaspddef<-list()
for(i in 1:100){
...
write.csv(plasrpd100df,"out/plasrpd100.csv")#Save Plasmodium RPD 
# Haemoproteus ####
...
write.csv(haepsv100df,"out/haepsv100.csv")
haepddef<-list()
for(i in 1:100){
...
write.csv(haerpd100df,"out/haerpd100.csv")
# Leucocytozoon ####
...
write.csv(leupsv100df,"out/leupsv100.csv")
leupddef<-list()
for(i in 1:100){
...
write.csv(leurpd100df,"out/leurpd100.csv")
